    ...
    <div class="navbar-container">
        ...
        <div class="nav-menu horizontal">
            <div class="menu-section horizontal">
                ...
                <a class="menu-item" href="{{ route('admin_stats') }}">
                    <svg class="menu-icon" viewBox="0 0 24 24">
                ...
                <a class="menu-item" href="{{ route('magazine_creation') }}">
                    <svg class="menu-icon" viewBox="0 0 24 24">
                    ...
                    <span class="menu-text">Articles & magazines</span>
                </a>

                <a class="menu-item" href="{{ route('get_subs') }}">
                    <svg class="menu-icon" viewBox="0 0 24 24">
                ...
                <a class="menu-item" href="{{ route('get_respo') }}">
                    <svg class="menu-icon" viewBox="0 0 24 24">
                ...
                <a class="menu-item" href="{{ route('verify_users') }}">
                    <svg class="menu-icon" viewBox="0 0 24 24">
                ...
                <a class="menu-item" href="{{ route('get_magazines') }}">
                    <svg class="menu-icon" viewBox="0 0 24 24">
                        <path fill="currentColor" d="M12 4c-5 0-9 4-9 8s4 8 9 8 9-4 9-8-4-8-9-8zm0 2c3.87 0 7 3.13 7 6s-3.13 6-7 6-7-3.13-7-6 3.13-6 7-6zm0 2a4 4 0 1 0 0 8 4 4 0 0 0 0-8zm0 2a2 2 0 1 1 0 4 2 2 0 0 1 0-4z" />
                    </svg>
                    <span class="menu-text">Magazines Visibility</span>
                </a>
                ...
                <a class="menu-item menu-item-danger" href="{{ route('logout') }}">
                    <svg class="menu-icon" viewBox="0 0 24 24">
